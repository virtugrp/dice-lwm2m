...
public class LeshanClientBuilder {
     ...
     * <ul>
     * <li>Security(0) with one instance (DM server security): uri=<em>coap://leshan.eclipseprojects.io:5685</em>,
     * mode=NoSec</li>
    ...
    public LeshanClient build() {
        ...
        if (objectEnablers == null) {
            ...
            initializer.setInstancesForObject(LwM2mId.SECURITY,
                    Security.noSec("coap://leshan.eclipseprojects.io:5685", 12345));
